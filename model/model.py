...
class EnhancementNetNoNorm(nn.Module):
    def __init__(self):
        super().__init__()
        self.num_downs = 2
        ...
        self.conv4_1 = nn.Sequential(nn.Conv2d(128, 128, 3, 1, 1, padding_mode='reflect'))
    ...
    def forward(self, x):
        ...
        return T, A, J.clamp(0, 1)



class AConstNoNorm(nn.Module):
    def __init__(self):
        super().__init__()
        self.num_downs = 3
        self.downscale = 2**self.num_downs
...
class AConstNoNormSmall(nn.Module):
    def __init__(self):
        super().__init__()
        self.num_downs = 2
        self.downscale = 2**self.num_downs
...
class AConstNoNormNearest(nn.Module):
    def __init__(self):
        super().__init__()
        self.num_downs = 3
        self.downscale = 2**self.num_downs
...
class UNet_Res(nn.Module):
    def __init__(self):
        ...
        self.l1_up = nn.ConvTranspose2d(32, 6, 4, 2, 1)
...
class UNet_Res_TBlur(nn.Module):
    def __init__(self):
        super().__init__()
        self.num_downs=5
...
class UNet_Res_Refine(nn.Module):
    def __init__(self):
        super().__init__()
        self.num_downs=5
...
class AConstNoNormNearestTBlur(nn.Module):
    def __init__(self):
        super().__init__()
        self.num_downs = 3
        self.downscale = 2**self.num_downs
