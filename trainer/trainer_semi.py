...
class Trainer(torch.nn.Module):
    def __init__(self, args):
        ...
        paired_train_dataset = train_paired_dataset_module(root=args["dataroot"], mode='val', patch_size=self.args["patchsize"])
        g = torch.Generator()
        g.manual_seed(args["seed"])
        ...
        shutil.copy(os.path.join('trainer', 'trainer_semi.py'), os.path.join(self.out_dir, 'codes', 'trainer_semi.py'))
